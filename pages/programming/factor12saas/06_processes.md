...
|:--------|:-----------:|--------:|
| [V. Сборка, релиз, выполнение](05_build-release-run.md) | [Содержание](README.md) | [VII. Привязка портов (Port binding)](07_port-binding.md)|