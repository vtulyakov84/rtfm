...
Исторически существуют значительные различия между разработкой (разработчик делает живые изменения на локальном [развёртывании](01_codebase.md) приложения) и работой приложения (развёртывание приложения с доступом к нему конечных пользователей). Эти различия проявляются в трёх областях:
...
<table>
    <tr>
        <td></td>
        <td>Традиционное приложение</td>
        <td>Приложение 12 факторов</td>
    </tr>
    <tr>
        <td>Время между развертываниеями</td>
        <td>Недели</td>
        <td>Часы</td>
    </tr>
    <tr>
        <td>Автор кода/тот кто разворачивает/td>
        <td>Разные люди</td>
        <td>Те же люди</td>
    </tr>
    <tr>
        <td>Окружение разработк/работы приложения</td>
        <td>Различные</td>
