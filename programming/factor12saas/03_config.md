...
*Конфигурация* приложения – это всё, что может меняться между [развёртываниями](01_codebase.md) (среда разработки, промежуточное и рабочее развёртывание). Это включает в себя:

* Идентификаторы подключения к ресурсам типа базы данных, кэш-памяти и другим [сторонним службам](04_backing-services.md)
...
|:--------|:-----------:|--------:|
| [II. Зависимости](02_dependencies.md) | [Содержание](README.md) | [IV. Сторонние службы (Backing Services)](04_backing-services.md)|