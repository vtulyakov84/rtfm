...
**[Процессы](06_processes.md) приложения двенадцати факторов являются утилизируемыми, это означает, что они могут быть запущены и остановлены в любой момент.** Это способствует стабильному и гибкому масштабированию, быстрому развёртыванию изменений [кода](01_codebase.md) и [конфигураций](03_config.md) и надёжности рабочего развёртывания.
...
|:--------|:-----------:|--------:|
| [VIII. Параллелизм](08_concurrency.md)](07_port-binding.md) | [Содержание](README.md) | [X. Паритет разработки/работы приложения](10_dev-prod-parity.md)|